...
pressureNotorietyWeight = 1 -- The amount to multiply the notoriety value which will be subtracted from base frequency
...
-- The reasons offered by police when demanding cash. (Optional list of months during the year when the reason applies)
demandCashReasons = {
...
-- The contribution towards the investigate suspicion level depending on the faction rating with the police 
factionRatingInvestigateModifier = {
    enemyOfTheState = 10,
    wantedSuspect = 5,
    nobody  = -5,
    honoraryDeputy = -10,
...
-- POSSIBLE bug START: positive values & seemingly does not account for "enemy of the state" -500 penalty for lack of bribes
...
-- The squads to send depending on building size and police faction
raidSquadsPerBuildingSize = {
...
-- Raid Bribe Values
--------------------------
-- The chance of the bribe succeeding, depending on the faction
raidBribeSuccessChance = {
    ["FACTION.CHICAGO_POLICE"] = 0.8,
    ["FACTION.BUREAU_OF_PROHIBITION"] = 0.5,
    ["FACTION.BUREAU_OF_INVESTIGATION"] = 0.1,
}

raidMinBribeAmount = 1000 -- The minimum cost of the bribe
 -- The base cost of the bribe, depending on the notoriety 
raidBribeNotorietyAmounts = {
    { notoriety = 0,  amount = 1000},
    { notoriety = 50, amount = 2500},
    { notoriety = 80, amount = 7500},
}

-- How much to affect the base bribe cost, depending on the faction rating
raidBribeFactionMultipliers = {
...
-- The number of weeks expenses to have in cash before considering a bribe to a faction
raidBribeExpensesConsideration = {
    ["FACTION.CHICAGO_POLICE"] = 4,
    ["FACTION.BUREAU_OF_PROHIBITION"] = 12,
    ["FACTION.BUREAU_OF_INVESTIGATION"] = 12,
}

-- The critical fail chance if a bribe fails
raidBribeCriticalFailChance = {
...
-- The contribution towards the raid chance depending on how many rackets they own (note, the table must be kept in order of num rackets)
numRacketsRaidFactionWeight = {
    { num = 0,  weight = 0  },
    { num = 2,  weight = 10 },
    { num = 5,  weight = 20 },
    { num = 10, weight = 30 },
...
-- The contribution towards the raid chance depending on owning large rackets (note, the table must be kept in order of num rackets)
largeRacketsFactionWeight = {
    { num = 0,  weight = 0 },
    { num = 1,  weight = 10},
    { num = 2,  weight = 20},
    { num = 3,  weight = 30},
...
-- The contribution towards the raid chance depending on owning breweries (note, the table must be kept in order of num breweries)
numBreweriesFactionWeight = {
    { num = 0,  weight = 0 },
    { num = 1,  weight = 20},
    { num = 2,  weight = 40},
    { num = 3,  weight = 60},
...
-- The contribution towards the raid chance depending on the faction rating with the police
factionRatingFactionWeight = {
    enemyOfTheState = 200,
    wantedSuspect = 100,
    nobody  = 30,
    honoraryDeputy = 0,
...
-- The contribution towards the raid chanced depending on your net income (note, the table must be kept in order of income)
netIncomeRaidFactionWeight = {
